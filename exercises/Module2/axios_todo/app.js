    ...
    .then(response => {
      for (let i = 0; i < response.data.length; i++) {
        ...
        checkbox.addEventListener("click", function() {
          ...
          // Conditional - if line is already through, then remove line, else add the line-through
          //             h1.style.textDecoration = "line-through";
        });
        ...
        delButton.addEventListener("click", function(e) {
          ...
          //the event object has access to its parent node
          //Remove that parent node
...
todoForm.addEventListener("submit", function(event) {
  ...
  axios
    ...
    //Call your new function that will generate this new todo
    .then(response => console.log(response.data))
    .catch(error => console.log(error));
});
...
var deleteTodo = function(id) {
  axios.delete("https://api.vschool.io/brandonartigue/todo/" + id).then(
    function(response) {
...
var putTodo1 = function(id) {
  axios.put("https://api.vschool.io/brandonartigue/todo/" + id, update1).then(
    function(response) {
...
var putTodo2 = function(id) {
  axios.put("https://api.vschool.io/brandonartigue/todo/" + id, update2).then(
    function(response) {
